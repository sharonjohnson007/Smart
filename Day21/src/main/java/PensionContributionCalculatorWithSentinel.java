...
/**
 * To calculate PensionContribution and shall repeat the calculation until user enter SENTINEL value -1;
 */
public class PensionContributionCalculatorWithSentinel {
    ...
    public static void main(String[] args) {
        PensionContributionCalculatorWithSentinel contribute = new PensionContributionCalculatorWithSentinel();
        int salary, age;
        ...
        salary = in.nextInt();
        while (salary != contribute.SENTINEL) {
            if (salary > 6000) {
